...
export default function HostsError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] p-8">
      ...
      <h2 className="text-xl font-semibold text-foreground mb-2">Failed to load machines</h2>
      <p className="text-muted-foreground text-center max-w-md mb-6">
        Something went wrong loading your machines. Please try again.
      </p>
      <button
        onClick={reset}
