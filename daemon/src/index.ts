...
import { startHeartbeatLoop, stopHeartbeatLoop, sendHeartbeat } from "./heartbeat.js";
import { initAgentManager, shutdownAllAgents, getIsolationMode, getAgentCount } from "./agent-manager.js";
